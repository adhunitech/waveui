...
main() {
  ...
  result += '      \'ShadcnApp(\\n\'\n';
  result += '      \'  theme: ThemeData(colorScheme: ColorSchemes.\${label.toLowerCase()}(ThemeMode.light)),\\n\'\n';
  result += '      \'  darkTheme: ThemeData(colorScheme: ColorSchemes.\${label.toLowerCase()}(ThemeMode.dark)),\\n\'\n';
  result += '      \'  themeMode: ThemeMode.system, // optional, default is ThemeMode.system\\n\'\n';
  result += '      \')\\n\'\n';
  result += '      \'or:\\n\'\n';
  result += '      \'ShadcnApp(\\n\'\n';
  ...
  result += '      \'instead of:\\n\'\n';
  result += '      \'ShadcnApp(\\n\'\n';
  result += '      \'  theme: ThemeData(colorScheme: ColorSchemes.\${label.toLowerCase()}(ThemeMode.system)),\\n\'\n';
  result += '      \')\'));\n';
...
String printTheme(String name, Map config) {
  ...
  for (var key in values.keys) {
    ...
    result += '\t\t\t$paramName: const HSLColor.fromAHSL(1, $hValue, $sValue, $lValue).toColor(),\n';
  }
  // print('\t\t);');
  // print('\t}');
  // print('');
