...
main() {
  String fontFamily = 'BootstrapIcons'; // as defined in pubspec.yml (not bootstrap-icons as defined in the font file)
  ...
  for (String key in generalizedIcons.keys) {
    builder +=
        '  static const IconData $key = IconData(${generalizedIcons[key]}, fontFamily: \'$fontFamily\', fontPackage: \'waveui\');\n';
  }
  builder += '}\n';
  targetClass.writeAsStringSync(builder);

  String iconDocsClass = 'import \'package:waveui/waveui.dart\';\nconst Map<String, IconData> kBootstrapIcons = {\n';
