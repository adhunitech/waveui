...
class _CodeSnippetFutureBuilderState extends State<CodeSnippetFutureBuilder> {
  ...
  void _refresh() {
    //https://raw.githubusercontent.com/adhunitech/waveui/master/docs/lib/pages/docs/layout_page/layout_page_example_1.dart
    String url = 'https://raw.githubusercontent.com/adhunitech/waveui/master/docs/${widget.path}';
            ...
            return CodeSnippet(
              ...
              actions: [
                GhostButton(
                  ...
                  onPressed: () {
                    // open in new tab
                    String url = 'https://github.com/adhunitech/waveui/blob/master/docs/${widget.path}';
          ...
          return CodeSnippet(
            ...
            actions: [
              GhostButton(
                ...
                onPressed: () {
                  // open in new tab
                  //https://github.com/adhunitech/waveui/blob/master/docs/lib/pages/docs/layout_page/layout_page_example_1.dart
                  String url = 'https://github.com/adhunitech/waveui/blob/master/docs/${widget.path}';
                  // html.window.open(url, 'blank');
                  launchUrlString(url);
                },
