    ...
    return DocsPage(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Welcome to waveui, a versatile and comprehensive set '
          ...
          Column(
            ...
            children: [
              ...
              const Text(
                      'Supports both Material and Cupertino Widgets with theme being able to adapt to the current waveui theme.')
                  .li(),
