...
class _InstallationPageState extends State<InstallationPage> {
  ...
  Widget build(BuildContext context) => DocsPage(
    name: 'installation',
    onThisPage: {'Stable Version': _manualKey, 'Experimental Version': _experimentalKey},
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        const Text('Installation').h1(),
        const Text('Install and configure waveui in your project.').lead(),
          ...
          children: [
            StepItem(
              ...
              content: [
                ...
                const CodeSnippet(code: 'flutter create my_app\ncd my_app', mode: 'shell').p(),
              ],
            ),
            StepItem(
              title: const Text('Adding the dependency'),
              content: [
                const Text('Next, add the waveui dependency to your project.').p(),
                const CodeSnippet(code: 'flutter pub add waveui', mode: 'shell').p(),
              ],
            ),
            StepItem(
              ...
              content: [
                ...
                const CodeSnippet(code: "import 'package:waveui/waveui.dart';", mode: 'dart').p(),
              ],
            ),
            StepItem(
    ...
    ShadcnApp(
      ...
      theme: ThemeData(
        ...
        const CodeSnippet(
          // code: 'waveui:\n'
          //     '  git:\n'
          //     '    url: "https://github.com/adhunitech/waveui.git"',
          code:
              'dependencies:\n'
              '  waveui:\n'
              '    git:\n'
