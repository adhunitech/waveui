                ...
                StepItem(
                  ...
                  content: [
                    ...
                    const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      CodeSnippet(
                        code:
                            '<script src="https://cdn.jsdelivr.net/gh/adhunitech/waveui@latest/web_loaders/standard.js"></script>',
                        mode: 'javascript',
                      ),
                    ]).li().p(),
                  ],
            ...
            Alert(
              ...
              content:
                  const Text('If you have a preloader that you want to share, please create a pull request under the ')
                      .thenButton(
                          onPressed: () {
                            launchUrlString('https://github.com/adhunitech/waveui/tree/master/web_loaders');
                          },
