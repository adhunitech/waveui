      ...
      child: Column(
        ...
        children: [
          ...
          const Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Expanded(child: Text('You can customize the scale of waveui components by changing the scaling.')),
            ],
          ).p(),
          Slider(
          ...
          const Alert(
            ...
            content: Text('This does not scale the entire app. Only waveui components are affected.'),
          ),
