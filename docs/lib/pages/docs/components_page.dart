      ...
      child: DocsPage(
        ...
        child: Column(
          ...
          children: [
                      ...
                      children: [
                        Positioned.fill(
                          child: RepeatedAnimationBuilder(
                            ...
                            builder: (context, value, child) => Container(color: value),
                          ),
                        ),
                        Positioned(
                          top: 8,
              ...
              children: [
                ...
                ComponentCard(
                  ...
                  example: Card(
                    child: Collapsible(
                      children: [
                        const CollapsibleTrigger(child: Text('@adhunitech starred 3 repositories')),
                        OutlinedContainer(
                          child: const Text(
                            '@adhunitech/waveui',
                        ...
                        const CollapsibleTrigger(child: Text('@flutter starred 1 repository')).withPadding(top: 16),
                        OutlinedContainer(
                          child: const Text(
                            '@adhunitech/waveui',
                          ).small().mono().withPadding(horizontal: 16, vertical: 8),
            ...
            wrap(
              children: [
                ...
                ComponentCard(
                  ...
                  center: true,
                  example: Transform.scale(scale: 3, child: const CircularProgressIndicator()),
                ),
                ComponentCard(
                  title: 'Progress',
                  name: 'progress',
                  ...
                  example: Stack(
                    children: [
                      ...
                      Transform.translate(
                        ...
                        child: Transform.scale(scale: 0.9, child: Opacity(opacity: 0.75, child: _buildToast())),
                      ),
                      _buildToast(),
                    ],
                  ),
            ...
            wrap(
              children: [
                ...
                ComponentCard(
                  ...
                  example: Card(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Checkbox(state: CheckboxState.checked, trailing: const Text('Checked'), onChanged: (value) {}),
                        Checkbox(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    const Gap(4),
                                    const Text('Chip 4'),
                                    VerticalDivider(color: theme.colorScheme.primary).sized(height: 18),
                                  ],
                                ).gap(4),
                              ],
                            ),
                ...
                ComponentCard(
                  ...
                  reverse: true,
                  reverseVertical: true,
                  example: Card(child: ColorPickerSet(color: ColorDerivative.fromColor(Colors.blue))),
                ),
                const ComponentCard(
                  name: 'date_picker',
                  title: 'Date Picker',
                            ...
                            child: SelectPopup(
                              items: SelectItemList(
                                children: [
                                  ...
                                  SelectItemButton(value: 'Cucumber', child: Text('Cucumber')),
                                ],
                              ),
                            ),
                          ),
                ...
                ComponentCard(
                  ...
                  center: true,
                  scale: 2,
                  example: Slider(value: const SliderValue.single(0.75), onChanged: (value) {}).sized(width: 100),
                ),
                const ComponentCard(
                  name: 'star_rating',
                  title: 'Star Rating',
                  ...
                  example: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [StarRating(starSize: 64, value: 3.5), Gap(16), StarRating(starSize: 64, value: 2.5)],
                  ),
                ),
                ComponentCard(
                  name: 'switch',
            ...
            wrap(
              children: [
                const ComponentCard(name: 'card', title: 'Card', example: CardExample1()),
                const ComponentCard(
                  name: 'carousel',
                  title: 'Carousel',
                  fit: true,
                ...
                const ComponentCard(title: 'Resizable', name: 'resizable', scale: 1, example: ResizableExample3()),
                const ComponentCard(
                  name: 'steps',
                  title: 'Steps',
                  example: Card(
                    ...
                    child: Steps(
                      children: [
                        StepItem(title: Text('Create a project'), content: [Text('Create a new flutter project')]),
                        StepItem(title: Text('Add dependencies'), content: [Text('Add dependencies to pubspec.yaml')]),
                        StepItem(title: Text('Run the project'), content: [Text('Run the project using flutter run')]),
                      ],
                    ),
                  ),
                ),
            ...
            wrap(
              children: [
                      ...
                      children: [
                        NavigationMenu(
                          children: [
                            ...
                            const NavigationMenuItem(content: SizedBox(), child: Text('Components')),
                          ],
                        ),
                        const Gap(8),
                        OutlinedContainer(
                ...
                const ComponentCard(name: 'tree', title: 'Tree', scale: 1.5, example: TreeExample1()),
              ],
            ),
              ...
              children: [
                ComponentCard(
                  ...
                  example: AlertDialog(
                            ...
                            child: FormTableLayout(
                              rows: [
                                FormField<String>(
                                  key: FormKey(#name),
                                  label: Text('Name'),
                                  child: TextField(initialValue: 'Thito Yalasatria Sunarya'),
                                ),
                                FormField<String>(
                    ...
                    actions: [PrimaryButton(child: const Text('Save changes'), onPressed: () {})],
                  ),
                ),
                ComponentCard(
                  title: 'Drawer',
                ...
                ComponentCard(
                  ...
                  example: Stack(
                    children: [
                      ...
                      const Positioned(top: 13, left: 160, child: CustomPaint(painter: CursorPainter())),
                    ],
                  ),
                ),
                ComponentCard(
                ...
                ComponentCard(
                  ...
                  example: Stack(
                    children: [
                      ...
                      const Positioned(top: 25, left: 100, child: CustomPaint(painter: CursorPainter())),
                    ],
                  ),
                ),
                ComponentCard(
              ...
              children: [
                  ...
                  example: Card(
                    child: Row(
                      children: [
                        ...
                        const Gap(16),
                        Avatar(initials: Avatar.getInitials('adhunitech')),
                      ],
                    ),
                  ),
                ),
                ComponentCard(
                  ...
                  example: AvatarGroup.toLeft(
                    children: [
                      Avatar(initials: Avatar.getInitials('adhunitech'), backgroundColor: Colors.red),
                      Avatar(initials: Avatar.getInitials('adhunitech'), backgroundColor: Colors.green),
                      Avatar(initials: Avatar.getInitials('adhunitech'), backgroundColor: Colors.blue),
                      Avatar(initials: Avatar.getInitials('adhunitech'), backgroundColor: Colors.yellow),
                    ],
                  ),
                ),
            ...
            wrap(
              children: [
                ...
                const ComponentCard(name: 'command', title: 'Command', scale: 1, example: CommandExample1()),
                ComponentCard(
                  title: 'Context Menu',
                  name: 'context_menu',
                  scale: 1.2,
                        ...
                        child: MenuPopup(
                          children: [
                            ...
                            Button(
                              style: const ButtonStyle.menu(),
                              onPressed: () {},
                              trailing: const MenuShortcut(activator: SingleActivator(LogicalKeyboardKey.delete)),
                              child: const Text('Delete'),
                            ),
                            Button(
                              style: const ButtonStyle.menu(),
                ...
                ComponentCard(
                  ...
                  example: Stack(
                    children: [
                      ...
                      const Positioned(top: 105, left: 170, child: CustomPaint(painter: CursorPainter())),
                    ],
                  ),
                ),
              ],
...
class WIPComponentCard extends StatelessWidget implements IComponentPage {
  ...
  const WIPComponentCard({required this.title, super.key});
                                ...
                                child: Transform.rotate(
                                  ...
                                  child: widget.fit
                                      ? Padding(
                                          ...
                                          child: FittedBox(child: widget.example),
                                        )
                                      : widget.center
                                      ? Center(
                                          child: Transform.scale(
