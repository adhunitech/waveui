...
import 'package:docs/pages/docs/components/calendar/calendar_example_3.dart';
import 'package:docs/pages/docs/components/calendar/calendar_example_4.dart';

class CalendarExample extends StatelessWidget {
  const CalendarExample({super.key});

  @override
  Widget build(BuildContext context) => const ComponentPage(
    name: 'calendar',
