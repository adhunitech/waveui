...
import 'package:waveui/waveui.dart' as shadcnui;
          ...
          children: <Widget>[
            ...
            shadcnui.ShadcnUI(
              ...
              child: Column(
                ...
                children: [
                  const Text('You can also use waveui widgets inside Material widgets'),
                  const shadcnui.Gap(16),
                  ...
                  shadcnui.SecondaryButton(
                      ...
                      shadcnui.showDialog(
                        ...
                        builder: (context) {
                          return shadcnui.AlertDialog(
                            title: const Text('Hello'),
                            content: const Text('This is waveui dialog'),
                            actions: [
                              shadcnui.PrimaryButton(
                                onPressed: () {
                                  Navigator.of(context).pop();
                    ...
                    child: const Text('Open waveui Dialog'),
                  ),
                ],
              ),
            )),
