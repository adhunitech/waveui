    ...
    return DocsPage(
      ...
      child: Column(
        ...
        children: [
          ...
          const SelectableText('A comprehensive guide to managing state in waveui.').lead(),
          const SelectableText('In Flutter, everything is a widget, including where your data is stored.').p(),
          const SelectableText('Internally, waveui has its own state management system. '
                  'Although if you are already using a state management system, '
                  'you can continue to use it with waveui.')
              .p(),
