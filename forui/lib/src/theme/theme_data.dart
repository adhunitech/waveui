...
final class FThemeData with Diagnosticable, FTransformable {
  ...
  ThemeData toApproximateMaterialTheme() {
    ...
    final textTheme = TextTheme(
      displayLarge: typography.h1.copyWith(
        height: 1,
        textBaseline: typography.h1.textBaseline ?? TextBaseline.alphabetic,
      ),
      displayMedium: typography.h2.copyWith(
        height: 1,
        textBaseline: typography.h2.textBaseline ?? TextBaseline.alphabetic,
      ),
      displaySmall: typography.h3.copyWith(
        height: 1,
        textBaseline: typography.h3.textBaseline ?? TextBaseline.alphabetic,
      ),
      headlineLarge: typography.h2.copyWith(
        height: 1,
        textBaseline: typography.h2.textBaseline ?? TextBaseline.alphabetic,
      ),
      headlineMedium: typography.h3.copyWith(
        height: 1,
        textBaseline: typography.h3.textBaseline ?? TextBaseline.alphabetic,
      ),
      headlineSmall: typography.h5.copyWith(
        height: 1,
        textBaseline: typography.h5.textBaseline ?? TextBaseline.alphabetic,
      ),
      titleLarge: typography.h4.copyWith(
        height: 1,
        textBaseline: typography.h4.textBaseline ?? TextBaseline.alphabetic,
      ),
      titleMedium: typography.h5.copyWith(
        height: 1,
        textBaseline: typography.h5.textBaseline ?? TextBaseline.alphabetic,
      ),
      titleSmall: typography.h6.copyWith(
        height: 1,
        textBaseline: typography.h6.textBaseline ?? TextBaseline.alphabetic,
      ),
      labelLarge: typography.bodyLarge.copyWith(
        height: 1,
        textBaseline: typography.bodyLarge.textBaseline ?? TextBaseline.alphabetic,
      ),
      labelMedium: typography.body.copyWith(
        height: 1,
        textBaseline: typography.body.textBaseline ?? TextBaseline.alphabetic,
      ),
      labelSmall: typography.mutedText.copyWith(
        height: 1,
        textBaseline: typography.mutedText.textBaseline ?? TextBaseline.alphabetic,
      ),
      ...
      bodySmall: typography.mutedText.copyWith(
        height: 1,
        textBaseline: typography.mutedText.textBaseline ?? TextBaseline.alphabetic,
      ),
    )..apply(
