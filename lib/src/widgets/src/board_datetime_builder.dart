...
/// }
/// ```
class BoardDateTimeBuilder<T extends BoardDateTimeCommonResult> extends StatefulWidget {
...
class _BoardDateTimeBuilderState<T extends BoardDateTimeCommonResult> extends State<BoardDateTimeBuilder<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.resizeBottom) {
      return Scaffold(
        ...
        body: Column(children: [Expanded(child: widget.builder(context)), child()]),
      );
    } else {
      return Scaffold(
        backgroundColor: Colors.transparent,
...
class SingleBoardDateTimeContent<T extends BoardDateTimeCommonResult> extends BoardDateTimeContent<T> {
  ...
  @override
  State<SingleBoardDateTimeContent> createState() => _SingleBoardDateTimeContentState<T>();
}
...
class _SingleBoardDateTimeContentState<T extends BoardDateTimeCommonResult>
  ...
  void notify() {
    ...
    widget.onResult?.call(BoardDateTimeCommonResult.init(pickerType, dateState.value) as T);
    setState(() {
      changedDate = true;
    });
  }
      ...
      child: SizeTransition(
        ...
        child: Column(
          ...
          children: [
            ...
            isWide
                ? PickerCalendarWideWidget(arguments: args, closeKeyboard: closeKeyboard)
