...
class _DatePickerModeToggleButtonState extends State<_DatePickerModeToggleButton> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final Color controlColor = colorScheme.labelPrimary.withOpacity(0.60);
                        ...
                        children: <Widget>[
                          Flexible(
                            child: Text(
                              ...
                              style: textTheme.small.copyWith(color: controlColor),
                            ),
                          ),
                          RotationTransition(
                            turns: _controller,
                            child: Icon(WaveIcons.caret_down_12_filled, color: controlColor, size: 16),
                          ),
                        ],
                      ),
                    ),
...
class _MonthPickerState extends State<_MonthPicker> {
  ...
  @override
  Widget build(BuildContext context) {
    final Color controlColor = WaveApp.themeOf(context).colorScheme.labelPrimary.withOpacity(0.60);
            ...
            child: Padding(
              ...
              child: Row(
                children: <Widget>[
                  const Spacer(),
                  IconButton(
                    icon: const Icon(WaveIcons.chevron_left_12_regular),
                    color: controlColor,
                    iconSize: 20,
                  ...
                  IconButton(
                    icon: const Icon(WaveIcons.chevron_right_12_regular),
                    color: controlColor,
                    iconSize: 20,
...
class _DayState extends State<_Day> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color? dayBackgroundColor = resolve<Color?>(
      (DatePickerThemeData? theme) => widget.isToday ? theme?.todayBackgroundColor : theme?.dayBackgroundColor,
      states,
    );
