...
class WaveHorizontalStepsState extends State<WaveHorizontalSteps> {
  ...
  Widget _getCompletedIcon(WaveUIStep step) {
    ...
    /// 使用组件默认的icon
    return WaveUITools.getAssetSizeImage(WaveAsset.iconStepCompleted, 20, 20, color: _primary);
  }
  ...
  Widget _getDoingIcon(WaveUIStep step) {
    ...
    // 使用组件默认的icon
    return WaveUITools.getAssetSizeImage(WaveAsset.iconStepDoing, 20, 20, color: _primary);
  }
}
