...
class WaveMultiRangePickerCommonItem extends StatelessWidget {
  ...
  const WaveMultiRangePickerCommonItem({
    super.key,
    required this.item,
  ...
  FontWeight _getItemFontWeight() {
    FontWeight fontWeight =
        (item.isUnLimit() ? isCurrentFocused : item.isSelected)! ? FontWeight.w600 : FontWeight.normal;
  ...
  String _getSelectedItemCount(WavePickerEntity item) {
    String itemCount = "";
    if ((WaveMultiColumnPickerUtil.getTotalColumnCount(item) < 3 || !isFirstLevel)) {
