...
class WaveTimeWidget extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _WaveTimeWidgetState(minDateTime, maxDateTime, initDateTime, minuteDivider);
}
...
class _WaveTimeWidgetState extends State<WaveTimeWidget> {
  ...
  _WaveTimeWidgetState(DateTime? minTime, DateTime? maxTime, DateTime? initTime, int? minuteDivider) {
