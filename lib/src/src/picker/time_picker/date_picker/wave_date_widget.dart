...
class WaveDateWidget extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _WaveDateWidgetState(minDateTime, maxDateTime, initialDateTime);
}
...
class _WaveDateWidgetState extends State<WaveDateWidget> {
  ...
  _WaveDateWidgetState(DateTime? minDateTime, DateTime? maxDateTime, DateTime? initialDateTime) {
