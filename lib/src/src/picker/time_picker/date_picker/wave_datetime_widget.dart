...
class WaveDateTimeWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() =>
      _WaveDateTimeWidgetState(minDateTime, maxDateTime, initDateTime, minuteDivider);
}
...
class _WaveDateTimeWidgetState extends State<WaveDateTimeWidget> {
  ...
  _WaveDateTimeWidgetState(DateTime? minTime, DateTime? maxTime, DateTime? initTime, int? minuteDivider) {
    // check minTime value
