...
class WaveTimeRangeSideWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() =>
      _TimePickerWidgetState(minDateTime, maxDateTime, initialStartDateTime, minuteDivider, onInitSelectChange);
}
...
class _TimePickerWidgetState extends State<WaveTimeRangeSideWidget> {
  ...
  _TimePickerWidgetState(DateTime? minTime, DateTime? maxTime, DateTime? initStartTime, int? minuteDivider,
  ...
  void _initData(DateTime? minTime, DateTime? maxTime, DateTime? initStartTime, int? minuteDivider) {
    ...
    _startMinuteScrollCtrl =
        FixedExtentScrollController(initialItem: (_currStartMinute - _minuteRange.first) ~/ _minuteDivider);
    _startScrollCtrlMap = {
