...
import 'package:waveui/src/src/picker/time_picker/date_range_picker/wave_time_range_side_widget.dart';
...
class WaveTimeRangeWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() =>
      _TimePickerWidgetState(minDateTime, maxDateTime, initialStartDateTime, initialEndDateTime, minuteDivider);
}
...
class _TimePickerWidgetState extends State<WaveTimeRangeWidget> {
  ...
  _TimePickerWidgetState(
      DateTime? minTime, DateTime? maxTime, DateTime? initStartTime, DateTime? initEndTime, int minuteDivider) {
