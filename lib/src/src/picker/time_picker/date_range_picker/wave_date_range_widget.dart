...
import 'package:waveui/src/src/picker/time_picker/date_range_picker/wave_date_range_side_widget.dart';
...
class WaveDateRangeWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() =>
      _DatePickerWidgetState(minDateTime, maxDateTime, initialStartDateTime, initialEndDateTime);
}
...
class _DatePickerWidgetState extends State<WaveDateRangeWidget> {
  ...
  _DatePickerWidgetState(
      DateTime? minDateTime, DateTime? maxDateTime, DateTime? initialStartDateTime, DateTime? initialEndDateTime) {
    // handle current selected year、month、day
    _initData(initialStartDateTime, initialEndDateTime, minDateTime, maxDateTime);
  }

  void _initData(
      DateTime? initialStartDateTime, DateTime? initialEndDateTime, DateTime? minDateTime, DateTime? maxDateTime) {
