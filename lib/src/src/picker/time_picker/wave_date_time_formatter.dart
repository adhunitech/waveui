...
import 'package:waveui/src/src/picker/time_picker/date_picker/wave_date_picker.dart';
import 'package:waveui/src/src/picker/time_picker/date_range_picker/wave_date_range_picker.dart';
...
class DateTimeFormatter {
  ...
  static String generateDateFormat(String? dateFormat, WaveDateTimePickerMode pickerMode) {
  ...
  static String generateDateRangePickerFormat(String? dateFormat, WaveDateTimeRangePickerMode pickerMode) {
    if (dateFormat != null && dateFormat.isNotEmpty) {
      return dateFormat;
    }
    switch (pickerMode) {
  ...
  static List<String> splitDateFormat(String? dateFormat, {WaveDateTimePickerMode? mode}) {
