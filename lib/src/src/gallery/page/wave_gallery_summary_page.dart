...
import 'package:waveui/src/src/gallery/page/wave_gallery_detail_page.dart';
import 'package:waveui/src/src/navbar/wave_appbar.dart';
import 'package:waveui/src/src/scroll_anchor/wave_scroll_anchor_tab.dart';
      ...
      return Padding(
        ...
        child: WaveAnchorTab(
            ...
            tabIndexedBuilder: (c, i) {
              return BadgeTab(text: '${allConfig[i].title ?? ""}(${allConfig[i].configList?.length ?? 0})');
            },
    ...
    if (groupConfig.configList != null) {
      ...
      for (int i = 0; i < groupConfig.configList!.length; i++) {
        gridViews.add(GestureDetector(
          ...
          child: groupConfig.configList![i].buildSummaryWidget(context, widget.allConfig, groupId, i),
        ));
      }
