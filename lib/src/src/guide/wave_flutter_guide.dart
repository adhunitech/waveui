...
import 'package:waveui/src/src/guide/wave_pulse_widget.dart';
import 'package:waveui/src/src/guide/wave_tip_widget.dart';
...
class WaveGuide {
  ...
  void _showOverlay(
    ...
    _overlayEntry = OverlayEntry(
      builder: (BuildContext context) {
        ...
        if (screenSize.width != _lastScreenSize.width && screenSize.height != _lastScreenSize.height) {
                        ...
                        child: Stack(
                          children: [
                            ...
                            _maskBuilder(
                              ...
                              borderRadiusGeometry: _configMap[_currentStepIndex]['borderRadius'] ?? borderRadius,
                            ),
                          ],
                        ),
                      )
  ...
  void _createStepWidget(BuildContext context) {
    ...
    _stepWidget = widgetBuilder(StepWidgetParams(
      ...
      size: widgetSize,
      onNext: _currentStepIndex == stepCount - 1 ? () => _onFinish() : () => _onNext(context),
