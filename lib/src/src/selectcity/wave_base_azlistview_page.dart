...
class _BaseAZListViewPageState extends State<BaseAZListViewPage> {
          ...
          builder: (context, snapShot) {
            ...
            if (snapShot.connectionState == ConnectionState.done) {
              if (snapShot.hasError) {
                return WaveAbnormalStateUtils.getEmptyWidgetByState(context, AbnormalState.networkConnectError,
                    action: (index) {
                  setState(() {});
                });
              } else {
  ...
  Widget buildContentBody(data) {
    ...
    if (_dataList.isEmpty && top.isEmpty) {
      return WaveAbnormalStateUtils.getEmptyWidgetByState(context, AbnormalState.noData);
    }
