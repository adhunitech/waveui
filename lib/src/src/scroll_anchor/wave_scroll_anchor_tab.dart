...
class WaveAnchorTab extends StatefulWidget {
  ...
  @override
  _WaveScrollAnchorTabWidgetState createState() => _WaveScrollAnchorTabWidgetState();
}

class _WaveScrollAnchorTabWidgetState extends State<WaveAnchorTab> with SingleTickerProviderStateMixin {
  //用于控制 滑动
      ...
      children: <Widget>[
        WaveTabBar(
          ...
          onTap: (state, index) {
            ...
            tab = true;
            _scrollController
                .animateTo(_cardOffsetList[index], duration: const Duration(milliseconds: 100), curve: Curves.linear)
                .whenComplete(() {
              tab = false;
            });
          },
