...
typedef WaveSingleSelectOnItemClickCallback = void Function(BuildContext dialogContext, int index);
...
class WaveSingleSelectDialogWidget extends StatefulWidget {
  ...
  WaveSingleSelectDialogWidget(
    ...
    themeData = WaveThemeConfigurator.instance.getConfig(configId: themeData!.configId).dialogConfig.merge(themeData);
  }
...
class WaveSingleSelectDialogWidgetState extends State<WaveSingleSelectDialogWidget> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Container(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius:
                    BorderRadius.all(Radius.circular(WaveDialogUtils.getDialogRadius(widget.themeData!))), //设置四周圆角 角度
              ),
              child: Stack(
                children: <Widget>[
                  Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text(
                          widget.title,
                          style: WaveDialogUtils.getDialogTitleStyle(widget.themeData!),
                        ),
                      ),
                          ...
                          child: GestureDetector(
                            child: Container(
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: const BorderRadius.all(Radius.circular(6.0)), //设置四周圆角 角度
                                ),
                                alignment: Alignment.center,
                                height: 48,
              ...
              children: <Widget>[
                Expanded(
                  ...
                  child: Text(widget.conditions![index],
                      style: TextStyle(
                          fontWeight:
                              widget.conditions![index] == widget.checkedItem ? FontWeight.w600 : FontWeight.normal,
                          fontSize: 16,
                ...
                GestureDetector(
                  child: Container(
                    ...
                    child: widget.checkedItem == widget.conditions![index]
                        ? WaveUITools.getAssetImageWithBandColor(WaveAsset.iconSingleSelected)
