...
class WaveMiddleInputDialog {
  ...
  void _doShow(BuildContext context) {
    ...
    dialogMessageWidgets.add(TextField(
      ...
      style: TextStyle(fontSize: 14, color: WaveThemeConfigurator.instance.getConfig().commonConfig.colorTextBase),
      onChanged: (value) {
        value = value;
      },
      ...
      decoration: InputDecoration(
        ...
        hintText: hintText,
        hintStyle:
            TextStyle(fontSize: 14, color: WaveThemeConfigurator.instance.getConfig().commonConfig.colorTextHint),
        enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(4.0),
            borderSide: BorderSide(
              width: 0.5,
              color: WaveThemeConfigurator.instance.getConfig().commonConfig.colorTextHint,
            )),
