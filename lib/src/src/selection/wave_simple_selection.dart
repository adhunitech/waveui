import 'package:waveui/src/src/selection/bean/wave_filter_entity.dart';
...
typedef WaveSimpleSelectionOnSelectionChanged = void Function(List<ItemEntity> selectedParams);
    ...
    if (widget.items.isNotEmpty) {
      ...
      for (var filter in widget.items) {
        children.add(WaveSelectionEntity.simple(
            key: filter.key, value: filter.value, title: filter.name, type: widget.isRadio ? "radio" : "checkbox"));
      }
