...
class WaveMoreSelectionWidget extends StatefulWidget {
  ...
  @override
  _WaveMoreSelectionWidgetState createState() => _WaveMoreSelectionWidgetState();
}
...
class __FilterCommonTypeWidgetState extends State<_FilterCommonTypeWidget> {
  ...
  Widget _buildSelectionTag() {
    return GridView.count(
      ...
      children: widget.selectionEntity.currentShowTagByExpanded(isExpanded).map((WaveSelectionEntity data) {
        ...
        children: <Widget>[
          Expanded(
            child: _buildRangeField(
                WaveIntl.of(context).localizedResource.minValue, minController, minFocusNode, widget.themeData),
          ),
          Container(
//          height: 38,
            alignment: Alignment.center,
          ...
          Expanded(
            child: _buildRangeField(
                WaveIntl.of(context).localizedResource.maxValue, maxController, maxFocusNode, widget.themeData),
          ),
        ],
      );
    }
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
              ...
              enabledBorder: UnderlineInputBorder(
                  borderRadius: BorderRadius.circular(widget.themeData.tagRadius),
                  borderSide: BorderSide(width: 1, color: widget.themeData.commonConfig.borderColorBase)),
          ...
          child: GestureDetector(
            ...
            child: Row(
              ...
              children: <Widget>[
                Expanded(
                  child: Text(
                      _isEmptyCondition() ? WaveIntl.of(context).localizedResource.pleaseChoose : _getCondition(),
