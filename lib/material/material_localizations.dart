...
class DefaultMaterialLocalizations implements MaterialLocalizations {
  ...
  String _formatDayPeriod(TimeOfDay timeOfDay) => switch (timeOfDay.period) {
  ...
  @override
  String pageRowsInfoTitle(int firstRow, int lastRow, int rowCount, bool rowCountIsApproximate) =>
      rowCountIsApproximate ? '$firstRow–$lastRow of about $rowCount' : '$firstRow–$lastRow of $rowCount';
  ...
  @override
  String selectedRowCountTitle(int selectedRowCount) => switch (selectedRowCount) {
    0 => 'No items selected',
    1 => '1 item selected',
  ...
  static Future<MaterialLocalizations> load(Locale locale) =>
      SynchronousFuture<MaterialLocalizations>(const DefaultMaterialLocalizations());
