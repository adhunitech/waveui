...
class TextSelectionTheme extends InheritedTheme {
  const TextSelectionTheme({required this.data, required Widget child, super.key})
    : _child = child,
  ...
  @override
  Widget get child =>
      DefaultSelectionStyle(selectionColor: data.selectionColor, cursorColor: data.cursorColor, child: _child);
  ...
  @override
  Widget wrap(BuildContext context, Widget child) => TextSelectionTheme(data: data, child: child);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<TextSelectionThemeData>('data', data));
  }
}
