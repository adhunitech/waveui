...
class _LicensePageState extends State<LicensePage> {
  ...
  @override
  Widget build(BuildContext context) => _MasterDetailFlow(
...
class _PackagesViewState extends State<_PackagesView> {
  ...
  @override
  Widget build(BuildContext context) => FutureBuilder<_LicenseData>(
    future: licenses,
    builder:
        (context, snapshot) => LayoutBuilder(
  ...
  void _initDefaultDetailPage(_LicenseData data, BuildContext context) {
    ...
    _MasterDetailFlow.of(context).setInitialDetailPage(
      _DetailArguments(packageName, bindings.map((i) => data.licenses[i]).toList(growable: false)),
    );
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<Future<_LicenseData>>('licenses', licenses));
  }
}
...
class _PackageListTile extends StatelessWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(IntProperty('numberLicenses', numberLicenses));
...
enum _ActionLevel { top, view }

enum _LayoutMode { lateral, nested }
...
class _MasterDetailFlow extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(ObjectFlagProperty<_MasterViewBuilder>.has('masterViewBuilder', masterViewBuilder));
    properties.add(ObjectFlagProperty<_DetailPageBuilder>.has('detailPageBuilder', detailPageBuilder));
    properties.add(DoubleProperty('detailPageFABlessGutterWidth', detailPageFABlessGutterWidth));
  }
}
...
class _MasterDetailFlowState extends State<_MasterDetailFlow> implements _PageOpener {
    ...
    return NavigatorPopHandler(
      ...
      child: Navigator(
        ...
        onGenerateInitialRoutes:
            (navigator, initialRoute) => switch (focus) {
  ...
  MaterialPageRoute<void> _masterPageRoute(BuildContext context) => MaterialPageRoute<dynamic>(
    builder:
        (c) => BlockSemantics(
          child: _MasterPage(
            leading:
  ...
  MaterialPageRoute<void> _detailPageRoute(Object? arguments) => MaterialPageRoute<void>(
    builder:
        (context) => PopScope<void>(
...
class _MasterDetailScaffold extends StatefulWidget {
  ...
  final _DetailPageBuilder detailPageBuilder;
  final List<Widget> Function(BuildContext, _ActionLevel) actionBuilder;
...
class _MasterDetailScaffoldState extends State<_MasterDetailScaffold> implements _PageOpener {
          ...
          child: ValueListenableBuilder<Object?>(
            ...
            builder:
                (context, value, child) => AnimatedSwitcher(
                  transitionBuilder:
                      (child, animation) => const FadeUpwardsPageTransitionsBuilder().buildTransitions<void>(
                        null,
                        null,
                        animation,
                        null,
  ...
  ConstrainedBox _masterPanel(BuildContext context, {bool needsScaffold = false}) => ConstrainedBox(
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DoubleProperty('detailPageFABGutterWidth', detailPageFABGutterWidth));
    properties.add(DoubleProperty('detailPageFABlessGutterWidth', detailPageFABlessGutterWidth));
    properties.add(DoubleProperty('masterViewWidth', masterViewWidth));
  }
}
...
class _DetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DraggableScrollableSheet(
      ...
      expand: false,
      builder:
          (context, controller) => MouseRegion(
