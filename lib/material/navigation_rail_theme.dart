...
import 'package:waveui/material/navigation_rail.dart';
...
class NavigationRailTheme extends InheritedTheme {
  const NavigationRailTheme({required this.data, required super.child, super.key});
  ...
  @override
  Widget wrap(BuildContext context, Widget child) => NavigationRailTheme(data: data, child: child);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<NavigationRailThemeData>('data', data));
  }
}
