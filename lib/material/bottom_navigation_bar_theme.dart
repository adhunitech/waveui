...
import 'package:waveui/material/bottom_navigation_bar.dart';
...
class BottomNavigationBarTheme extends InheritedWidget {
  const BottomNavigationBarTheme({required this.data, required super.child, super.key});
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<BottomNavigationBarThemeData>('data', data));
  }
}
