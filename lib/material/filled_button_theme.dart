...
class FilledButtonTheme extends InheritedTheme {
  const FilledButtonTheme({required this.data, required super.child, super.key});
  ...
  @override
  Widget wrap(BuildContext context, Widget child) => FilledButtonTheme(data: data, child: child);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<FilledButtonThemeData>('data', data));
  }
}
