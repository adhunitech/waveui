...
import 'package:waveui/material/input_date_picker_form_field.dart';
    ...
    switch (_entryMode.value) {
      case DatePickerEntryMode.calendar:
        ...
        entryModeButton = IconButton(
          icon: widget.switchToInputEntryModeIcon ?? const Icon(Icons.edit_outlined),
...
class _DatePickerHeader extends StatelessWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(StringProperty('titleSemanticsLabel', titleSemanticsLabel));
    ...
    properties.add(DiagnosticsProperty<bool>('isShort', isShort));
  }
}
...
class DateRangePickerDialog extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<DateTimeRange?>('initialDateRange', initialDateRange));
    properties.add(DiagnosticsProperty<DateTime>('firstDate', firstDate));
    properties.add(DiagnosticsProperty<DateTime>('lastDate', lastDate));
    properties.add(DiagnosticsProperty<DateTime?>('currentDate', currentDate));
    properties.add(EnumProperty<DatePickerEntryMode>('initialEntryMode', initialEntryMode));
...
class _FocusedDate extends InheritedWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(EnumProperty<TraversalDirection?>('scrollDirection', scrollDirection));
  }
}
...
class _DayItem extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<bool>('isRangeSelected', isRangeSelected));
    properties.add(DiagnosticsProperty<bool>('isSelectedDayStart', isSelectedDayStart));
    properties.add(DiagnosticsProperty<bool>('isSelectedDayEnd', isSelectedDayEnd));
    properties.add(DiagnosticsProperty<bool>('isInRange', isInRange));
    properties.add(DiagnosticsProperty<bool>('isOneDayRange', isOneDayRange));
...
class _InputDateRangePickerDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
      ...
      child: Padding(
        ...
        child: Align(
          ...
          child: OverflowBar(
            spacing: 8,
            children: <Widget>[
              TextButton(onPressed: onCancel, child: Text(cancelText ?? localizations.cancelButtonLabel)),
    ...
    final double textScaleFactor =
        ...
        _fontSizeToScale;
    final Size dialogSize = _inputPortraitDialogSizeM3 * textScaleFactor;
    switch (orientation) {
      case Orientation.portrait:
...
class _InputDateRangePicker extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<bool>('autovalidate', autovalidate));
    properties.add(DiagnosticsProperty<TextInputType>('keyboardType', keyboardType));
    properties.add(
      ObjectFlagProperty<SelectableDayForRangePredicate?>.has('selectableDayPredicate', selectableDayPredicate),
    );
...
class _InputDateRangePickerState extends State<_InputDateRangePicker> {
  ...
  Widget build(BuildContext context) {
    ...
    final InputBorder inputBorder = inputTheme.border ?? const OutlineInputBorder();
