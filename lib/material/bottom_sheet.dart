...
import 'package:waveui/material/motion.dart';
...
class BottomSheet extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ColorProperty('dragHandleColor', dragHandleColor));
    properties.add(DiagnosticsProperty<Size?>('dragHandleSize', dragHandleSize));
    properties.add(ObjectFlagProperty<BottomSheetDragStartHandler?>.has('onDragStart', onDragStart));
    properties.add(ObjectFlagProperty<BottomSheetDragEndHandler?>.has('onDragEnd', onDragEnd));
...
class _DragHandle extends StatelessWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(ObjectFlagProperty<VoidCallback?>.has('onSemanticsTap', onSemanticsTap));
    properties.add(ObjectFlagProperty<ValueChanged<bool>>.has('handleHover', handleHover));
    properties.add(IterableProperty<WidgetState>('states', states));
    properties.add(ColorProperty('dragHandleColor', dragHandleColor));
    properties.add(DiagnosticsProperty<Size?>('dragHandleSize', dragHandleSize));
  }
}
...
class _BottomSheetLayoutWithSizeListener extends SingleChildRenderObjectWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(ObjectFlagProperty<ValueChanged<Size>>.has('onChildSizeChanged', onChildSizeChanged));
    ...
    properties.add(DoubleProperty('scrollControlDisabledMaxHeightRatio', scrollControlDisabledMaxHeightRatio));
  }
}
...
class _ModalBottomSheet<T> extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<ModalBottomSheetRoute<T>>('route', route));
    properties.add(DiagnosticsProperty<bool>('isScrollControlled', isScrollControlled));
    properties.add(DoubleProperty('scrollControlDisabledMaxHeightRatio', scrollControlDisabledMaxHeightRatio));
    properties.add(ColorProperty('backgroundColor', backgroundColor));
    properties.add(DoubleProperty('elevation', elevation));
...
class _BottomSheetGestureDetector extends StatelessWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(ObjectFlagProperty<GestureDragStartCallback>.has('onVerticalDragStart', onVerticalDragStart));
    properties.add(ObjectFlagProperty<GestureDragUpdateCallback>.has('onVerticalDragUpdate', onVerticalDragUpdate));
    properties.add(ObjectFlagProperty<GestureDragEndCallback>.has('onVerticalDragEnd', onVerticalDragEnd));
  }
}
