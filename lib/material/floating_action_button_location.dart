...
abstract class StandardFabLocation extends FloatingActionButtonLocation {
  ...
  static double _leftOffsetX(ScaffoldPrelayoutGeometry scaffoldGeometry, double adjustment) =>
      kFloatingActionButtonMargin + scaffoldGeometry.minInsets.left - adjustment;
...
mixin FabStartOffsetX on StandardFabLocation {
  @override
  double getOffsetX(ScaffoldPrelayoutGeometry scaffoldGeometry, double adjustment) => switch (scaffoldGeometry
      .textDirection) {
...
class _NoAnimationFabMotionAnimator extends FloatingActionButtonAnimator {
  ...
  @override
  Animation<double> getScaleAnimation({required Animation<double> parent}) => const AlwaysStoppedAnimation<double>(1.0);
}
