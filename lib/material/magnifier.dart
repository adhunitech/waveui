...
class TextMagnifier extends StatefulWidget {
  const TextMagnifier({required this.magnifierInfo, super.key});
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<ValueNotifier<MagnifierInfo>>('magnifierInfo', magnifierInfo));
  }
}
...
class Magnifier extends StatelessWidget {
  const Magnifier({
    ...
    this.shadows = const <BoxShadow>[
      BoxShadow(blurRadius: 1.5, offset: Offset(0.0, 2.0), spreadRadius: 0.75, color: Color.fromARGB(25, 0, 0, 0)),
    ],
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<Offset>('additionalFocalPointOffset', additionalFocalPointOffset));
    properties.add(DiagnosticsProperty<BorderRadius>('borderRadius', borderRadius));
    properties.add(ColorProperty('filmColor', filmColor));
