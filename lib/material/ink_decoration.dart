...
class Ink extends StatefulWidget {
  Ink({super.key, this.padding, Color? color, Decoration? decoration, this.width, this.height, this.child})
  ...
  EdgeInsetsGeometry get _paddingIncludingDecoration => switch ((padding, decoration?.padding)) {
