...
import 'package:flutter/foundation.dart' show DiagnosticPropertiesBuilder, IterableProperty, ObjectFlagProperty, ValueListenable, clampDouble;
...
class _DesktopTextSelectionControlsToolbar extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<Offset?>('lastSecondaryTapDownPosition', lastSecondaryTapDownPosition));
