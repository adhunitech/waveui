...
class MaterialPointArcTween extends Tween<Offset> {
  ...
  @override
  String toString() =>
      '${objectRuntimeType(this, 'MaterialPointArcTween')}($begin \u2192 $end; center=$center, radius=$radius, beginAngle=$beginAngle, endAngle=$endAngle)';
}
...
class MaterialRectArcTween extends RectTween {
  ...
  void _initialize() {
    ...
    final _Diagonal diagonal = _maxBy<_Diagonal>(_allDiagonals, (d) => _diagonalSupport(centersVector, d));
  ...
  Offset _cornerFor(Rect rect, _CornerId id) => switch (id) {
  ...
  @override
  String toString() =>
      '${objectRuntimeType(this, 'MaterialRectArcTween')}($begin \u2192 $end; beginArc=$beginArc, endArc=$endArc)';
}
...
class MaterialRectCenterArcTween extends RectTween {
  ...
  @override
  String toString() =>
      '${objectRuntimeType(this, 'MaterialRectCenterArcTween')}($begin \u2192 $end; centerArc=$centerArc)';
}
