...
import 'package:waveui/material/dialog.dart';
...
import 'package:waveui/material/time.dart';
      ...
      case Orientation.portrait:
        return Column(
          ...
          children: <Widget>[
            ...
            Row(
              textDirection:
                  timeOfDayFormat == TimeOfDayFormat.a_space_h_colon_mm ? TextDirection.rtl : TextDirection.ltr,
              spacing: 12,
              children: <Widget>[
                Expanded(
                  child: Row(
...
class _DayPeriodControl extends StatelessWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(ObjectFlagProperty<ValueChanged<TimeOfDay>?>.has('onPeriodChanged', onPeriodChanged));
  }
}
...
class _DayPeriodInputPadding extends SingleChildRenderObjectWidget {
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => _RenderInputPadding(minSize, orientation);
...
class _Dial extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(EnumProperty<_HourMinuteMode>('hourMinuteMode', hourMinuteMode));
    properties.add(EnumProperty<_HourDialType>('hourDialType', hourDialType));
    properties.add(ObjectFlagProperty<ValueChanged<TimeOfDay>?>.has('onChanged', onChanged));
    properties.add(ObjectFlagProperty<VoidCallback?>.has('onHourSelected', onHourSelected));
  }
}
...
class _DialState extends State<_Dial> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _theta = _animationController.drive(CurveTween(curve: standardEasing)).drive(_thetaTween)..addListener(
      () => setState(() {
        /* _theta.value has changed */
      }),
    );
    _radius = _animationController.drive(CurveTween(curve: standardEasing)).drive(_radiusTween)..addListener(
      () => setState(() {
  ...
  static double _nearest(double target, double a, double b) => ((target - a).abs() < (target - b).abs()) ? a : b;
  ...
  TimeOfDay _getTimeForTheta(double theta, {required double radius, bool roundMinutes = false}) {
  ...
  void _selectHour(int hour) {
    ...
    TimeOfDay getAmPmTime() => switch (widget.selectedTime.period) {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<MaterialLocalizations>('localizations', localizations));
    properties.add(DiagnosticsProperty<_DialPainter?>('painter', painter));
  }
}
...
class _TimePickerInput extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<TimeOfDay>('initialSelectedTime', initialSelectedTime));
    properties.add(StringProperty('errorInvalidText', errorInvalidText));
    properties.add(StringProperty('hourLabelText', hourLabelText));
    properties.add(StringProperty('minuteLabelText', minuteLabelText));
    properties.add(StringProperty('helpText', helpText));
    properties.add(DiagnosticsProperty<bool?>('autofocusHour', autofocusHour));
    properties.add(DiagnosticsProperty<bool?>('autofocusMinute', autofocusMinute));
...
class _TimePickerInputState extends State<_TimePickerInput> with RestorationMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<RestorableBool>('hourHasError', hourHasError));
    properties.add(DiagnosticsProperty<RestorableBool>('minuteHasError', minuteHasError));
  }
}
...
class _HourTextField extends StatelessWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ObjectFlagProperty<ValueChanged<String?>>.has('onSavedSubmitted', onSavedSubmitted));
...
class _HourMinuteTextField extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<TimeOfDay>('selectedTime', selectedTime));
    properties.add(DiagnosticsProperty<bool>('isHour', isHour));
    properties.add(DiagnosticsProperty<bool?>('autofocus', autofocus));
    properties.add(EnumProperty<TextInputAction>('inputAction', inputAction));
    properties.add(DiagnosticsProperty<TextStyle>('style', style));
    properties.add(StringProperty('semanticHintText', semanticHintText));
    properties.add(ObjectFlagProperty<FormFieldValidator<String>>.has('validator', validator));
    properties.add(ObjectFlagProperty<ValueChanged<String?>>.has('onSavedSubmitted', onSavedSubmitted));
    properties.add(ObjectFlagProperty<ValueChanged<String>?>.has('onChanged', onChanged));
    properties.add(StringProperty('restorationId', restorationId));
...
class _HourMinuteTextFieldState extends State<_HourMinuteTextField> with RestorationMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<RestorableTextEditingController>('controller', controller));
    properties.add(DiagnosticsProperty<RestorableBool>('controllerHasBeenSet', controllerHasBeenSet));
...
class TimePickerDialog extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<TimeOfDay>('initialTime', initialTime));
    ...
    properties.add(StringProperty('minuteLabelText', minuteLabelText));
    properties.add(StringProperty('restorationId', restorationId));
    properties.add(EnumProperty<TimePickerEntryMode>('initialEntryMode', initialEntryMode));
    properties.add(EnumProperty<Orientation?>('orientation', orientation));
    properties.add(ObjectFlagProperty<EntryModeChangeCallback?>.has('onEntryModeChanged', onEntryModeChanged));
  }
}
...
class _TimePickerDialogState extends State<TimePickerDialog> with RestorationMixin {
  ...
  Size _dialogSize(BuildContext context) {
    ...
    final double textScaleFactor =
        MediaQuery.textScalerOf(context).clamp(maxScaleFactor: 1.1).scale(fontSizeToScale) / fontSizeToScale;
    ...
    switch (_entryMode.value) {
      ...
      case TimePickerEntryMode.dialOnly:
        switch (orientation) {
          ...
          case Orientation.landscape:
            timePickerSize = Size(_kTimePickerLandscapeSize.width * textScaleFactor, _kTimePickerLandscapeSize.height);
        }
      case TimePickerEntryMode.input:
      case TimePickerEntryMode.inputOnly:
        final MaterialLocalizations localizations = MaterialLocalizations.of(context);
...
class _TimePicker extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(StringProperty('restorationId', restorationId));
    properties.add(EnumProperty<TimePickerEntryMode>('entryMode', entryMode));
    properties.add(DiagnosticsProperty<TimeOfDay>('time', time));
    properties.add(ObjectFlagProperty<ValueChanged<TimeOfDay>?>.has('onTimeChanged', onTimeChanged));
    properties.add(EnumProperty<Orientation?>('orientation', orientation));
    properties.add(ObjectFlagProperty<EntryModeChangeCallback?>.has('onEntryModeChanged', onEntryModeChanged));
  }
}
...
class _TimePickerState extends State<_TimePicker> with RestorationMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final _TimePickerDefaults defaultTheme = _TimePickerDefaultsM3(context, entryMode: widget.entryMode);
    final Orientation orientation = _orientation.value ?? MediaQuery.orientationOf(context);
    final HourFormat timeOfDayHour = hourFormat(of: timeOfDayFormat);
    final _HourDialType hourMode = switch (timeOfDayHour) {
      HourFormat.HH || HourFormat.H => _HourDialType.twentyFourHourDoubleRing,
    ...
    switch (widget.entryMode) {
      ...
      case TimePickerEntryMode.input:
      case TimePickerEntryMode.inputOnly:
        final String helpText = localizations.timePickerInputHelpText;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<MaterialLocalizations>('localizations', localizations));
    properties.add(DiagnosticsProperty<RestorableTimeOfDay>('selectedTime', selectedTime));
  }
}
...
abstract class _TimePickerDefaults extends TimePickerThemeData {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<Size>('dayPeriodInputSize', dayPeriodInputSize));
    properties.add(DiagnosticsProperty<Size>('dayPeriodLandscapeSize', dayPeriodLandscapeSize));
    properties.add(DiagnosticsProperty<Size>('dayPeriodPortraitSize', dayPeriodPortraitSize));
    properties.add(DiagnosticsProperty<Size>('dialSize', dialSize));
    properties.add(DoubleProperty('handWidth', handWidth));
    properties.add(DoubleProperty('dotRadius', dotRadius));
    properties.add(DoubleProperty('centerRadius', centerRadius));
    properties.add(DiagnosticsProperty<Size>('hourMinuteSize', hourMinuteSize));
    properties.add(DiagnosticsProperty<Size>('hourMinuteSize24Hour', hourMinuteSize24Hour));
    properties.add(DiagnosticsProperty<Size>('hourMinuteInputSize', hourMinuteInputSize));
    properties.add(DiagnosticsProperty<Size>('hourMinuteInputSize24Hour', hourMinuteInputSize24Hour));
  }
}
...
class _TimePickerDefaultsM3 extends _TimePickerDefaults {
  ...
  @override
  OutlinedBorder get dayPeriodShape => const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(8.0))).copyWith(side: dayPeriodBorderSide);
  ...
  @override
  TextStyle get dayPeriodTextStyle => _textTheme.titleMedium!.copyWith(color: dayPeriodTextColor);
  ...
  @override
  Size get dialSize => const Size.square(256.0);

  @override
  double get handWidth => const Size(2, double.infinity).width;

  @override
  double get dotRadius => const Size.square(48.0).width / 2;

  @override
  double get centerRadius => const Size.square(8.0).width / 2;
  ...
  @override
  ShapeBorder get hourMinuteShape => const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(8.0)));

  @override
  Size get hourMinuteSize => const Size(96, 80);

  @override
  Size get hourMinuteSize24Hour => Size(const Size(114, double.infinity).width, hourMinuteSize.height);
  ...
  @override
  Color get hourMinuteTextColor => WidgetStateColor.resolveWith((states) => _hourMinuteTextColor.resolve(states));

  WidgetStateProperty<Color> get _hourMinuteTextColor => WidgetStateProperty.resolveWith((states) {
      if (states.contains(WidgetState.selected)) {
        if (states.contains(WidgetState.pressed)) {
  ...
  @override
  TextStyle get hourMinuteTextStyle => WidgetStateTextStyle.resolveWith((states) {
  ...
  @override
  ShapeBorder get shape => const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(28.0)));
