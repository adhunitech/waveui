...
class _PredictiveBackGestureDetector extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<PredictiveBackRoute>('route', route));
  }
}
...
class _PredictiveBackGestureDetectorState extends State<_PredictiveBackGestureDetector> with WidgetsBindingObserver {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<PredictiveBackEvent?>('startBackEvent', startBackEvent));
    properties.add(DiagnosticsProperty<PredictiveBackEvent?>('currentBackEvent', currentBackEvent));
  }
}
...
class _PredictiveBackPageTransition extends StatelessWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ObjectFlagProperty<ValueGetter<bool>>.has('getIsCurrent', getIsCurrent));
  }
}
