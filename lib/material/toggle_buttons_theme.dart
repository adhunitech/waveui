...
class ToggleButtonsTheme extends InheritedTheme {
  const ToggleButtonsTheme({required this.data, required super.child, super.key});
  ...
  @override
  Widget wrap(BuildContext context, Widget child) => ToggleButtonsTheme(data: data, child: child);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<ToggleButtonsThemeData>('data', data));
  }
}
