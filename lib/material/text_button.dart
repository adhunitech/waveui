...
class TextButton extends ButtonStyleButton {
  ...
  @override
  ButtonStyle defaultStyleOf(BuildContext context) => _TextButtonDefaultsM3(context);

  @override
  ButtonStyle? themeStyleOf(BuildContext context) => TextButtonTheme.of(context).style;
}
...
class _TextButtonWithIcon extends TextButton {
  _TextButtonWithIcon({
    ...
    IconAlignment? iconAlignment,
         ...
         autofocus: autofocus ?? false,
         child: _TextButtonWithIconChild(icon: icon, label: label, buttonStyle: style, iconAlignment: iconAlignment),
       );
...
class _TextButtonWithIconChild extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final IconAlignment effectiveIconAlignment =
        iconAlignment ?? textButtonTheme.style?.iconAlignment ?? buttonStyle?.iconAlignment ?? IconAlignment.start;
    return Row(
