...
class TimePickerTheme extends InheritedTheme {
  const TimePickerTheme({required this.data, required super.child, super.key});
  ...
  @override
  Widget wrap(BuildContext context, Widget child) => TimePickerTheme(data: data, child: child);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<TimePickerThemeData>('data', data));
  }
}
