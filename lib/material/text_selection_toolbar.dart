...
import 'package:flutter/foundation.dart' show ObjectFlagProperty, listEquals;
...
class TextSelectionToolbar extends StatelessWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<Offset>('anchorAbove', anchorAbove));
    properties.add(DiagnosticsProperty<Offset>('anchorBelow', anchorBelow));
    properties.add(ObjectFlagProperty<ToolbarBuilder>.has('toolbarBuilder', toolbarBuilder));
  }
}
...
class _TextSelectionToolbarOverflowable extends StatefulWidget {
  const _TextSelectionToolbarOverflowable({required this.isAbove, required this.toolbarBuilder, required this.children})
    : assert(children.length > 0);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<bool>('isAbove', isAbove));
    properties.add(ObjectFlagProperty<ToolbarBuilder>.has('toolbarBuilder', toolbarBuilder));
  }
}
...
class _TextSelectionToolbarTrailingEdgeAlign extends SingleChildRenderObjectWidget {
  ...
  _TextSelectionToolbarTrailingEdgeAlignRenderBox createRenderObject(BuildContext context) =>
      _TextSelectionToolbarTrailingEdgeAlignRenderBox(overflowOpen: overflowOpen, textDirection: textDirection);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<bool>('overflowOpen', overflowOpen));
...
class _TextSelectionToolbarItemsLayout extends MultiChildRenderObjectWidget {
  ...
  _RenderTextSelectionToolbarItemsLayout createRenderObject(BuildContext context) =>
      _RenderTextSelectionToolbarItemsLayout(isAbove: isAbove, overflowOpen: overflowOpen);
...
class _TextSelectionToolbarItemsLayoutElement extends MultiChildRenderObjectElement {
  ...
  static bool _shouldPaint(Element child) => (child.renderObject!.parentData! as ToolbarItemsParentData).shouldPaint;
...
class _TextSelectionToolbarOverflowButton extends StatelessWidget {
  const _TextSelectionToolbarOverflowButton({required this.icon, super.key, this.onPressed, this.tooltip});
