...
import 'package:waveui/material/material_button.dart';
import 'package:waveui/material/theme.dart';
import 'package:waveui/material/theme_data.dart' show MaterialTapTargetSize;

// Examples can assume:
// late BuildContext context;

enum ButtonTextTheme { normal, accent, primary }

enum ButtonBarLayoutBehavior { constrained, padded }
...
class ButtonTheme extends InheritedTheme {
  ...
  const ButtonTheme.fromButtonThemeData({required this.data, required super.child, super.key});
  ...
  @override
  Widget wrap(BuildContext context, Widget child) => ButtonTheme.fromButtonThemeData(data: data, child: child);
...
class ButtonThemeData with Diagnosticable {
  ...
  BoxConstraints get constraints => BoxConstraints(minWidth: minWidth, minHeight: height);
  ...
  ShapeBorder get shape =>
      ...
      switch (textTheme) {
        ...
        ButtonTextTheme.accent => const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(2.0))),
        ButtonTextTheme.primary => const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(4.0))),
      };
  ...
  Brightness getBrightness(MaterialButton button) => button.colorBrightness ?? colorScheme!.brightness;
  ...
  Duration getAnimationDuration(MaterialButton button) => button.animationDuration ?? kThemeChangeDuration;
  ...
  MaterialTapTargetSize getMaterialTapTargetSize(MaterialButton button) =>
      button.materialTapTargetSize ?? _materialTapTargetSize ?? MaterialTapTargetSize.padded;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(EnumProperty<ButtonBarLayoutBehavior>('layoutBehavior', layoutBehavior));
