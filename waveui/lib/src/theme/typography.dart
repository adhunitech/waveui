...
class Typography {
  ...
  const Typography.inter({
    this.sans = const TextStyle(fontFamily: 'Inter', package: 'waveui'),
    this.mono = const TextStyle(fontFamily: 'monospace'),
    this.xSmall = const TextStyle(
      fontSize: 12,
      fontFamily: 'Inter',
      package: 'waveui',
      height: 1.5,
    ...
    this.xLarge = const TextStyle(
      fontSize: 20,
      fontFamily: 'Inter',
      package: 'waveui',
      height: 1.5,
    ),
    this.x2Large = const TextStyle(
      fontSize: 24,
      fontFamily: 'Inter',
      package: 'waveui',
      height: 1.5,
    ),
    this.x3Large = const TextStyle(
      fontSize: 30,
      fontFamily: 'Inter',
      package: 'waveui',
      height: 1.5,
    ),
    this.x4Large = const TextStyle(
      fontSize: 36,
      fontFamily: 'Inter',
      package: 'waveui',
      height: 1.5,
    ),
    this.x5Large = const TextStyle(
      fontSize: 48,
      fontFamily: 'Inter',
      package: 'waveui',
      height: 1.5,
    ),
    this.x6Large = const TextStyle(
      fontSize: 60,
      fontFamily: 'Inter',
      package: 'waveui',
      height: 1.5,
    ),
    this.x7Large = const TextStyle(
      fontSize: 72,
      fontFamily: 'Inter',
      package: 'waveui',
      height: 1.5,
    ),
    this.x8Large = const TextStyle(
      fontSize: 96,
      fontFamily: 'Inter',
      package: 'waveui',
      height: 1.5,
    ),
    this.x9Large = const TextStyle(
      fontSize: 144,
      fontFamily: 'Inter',
      package: 'waveui',
      height: 1.5,
    ),
    this.thin = const TextStyle(
    ...
    this.extraLight = const TextStyle(
    ...
    this.extraBold = const TextStyle(
      fontWeight: FontWeight.w800,
      fontFamily: 'Inter',
      package: 'waveui',
      height: 1.5,
    ),
    this.black = const TextStyle(
    ...
    this.h1 =
        const TextStyle(fontFamily: 'Inter', package: 'waveui', fontSize: 36, height: 1.2, fontWeight: FontWeight.w700),
    this.h2 =
        const TextStyle(fontFamily: 'Inter', package: 'waveui', fontSize: 30, height: 1.2, fontWeight: FontWeight.w600),
    this.h3 =
        const TextStyle(fontFamily: 'Inter', package: 'waveui', fontSize: 24, height: 1.3, fontWeight: FontWeight.w600),
    this.h4 =
        const TextStyle(fontFamily: 'Inter', package: 'waveui', fontSize: 18, height: 1.4, fontWeight: FontWeight.w500),
    ...
    this.blockQuote = const TextStyle(
        ...
        fontWeight: FontWeight.w400,
        fontStyle: FontStyle.italic),
    this.inlineCode = const TextStyle(fontFamily: 'monospace', fontSize: 14, fontWeight: FontWeight.w600),
    this.lead = const TextStyle(fontSize: 20),
    this.textLarge =
        const TextStyle(fontFamily: 'Inter', package: 'waveui', height: 1.5, fontSize: 20, fontWeight: FontWeight.w600),
