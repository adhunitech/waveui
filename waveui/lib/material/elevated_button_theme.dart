...
class ElevatedButtonTheme extends InheritedTheme {
  const ElevatedButtonTheme({required this.data, required super.child, super.key});
  ...
  @override
  Widget wrap(BuildContext context, Widget child) => ElevatedButtonTheme(data: data, child: child);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<ElevatedButtonThemeData>('data', data));
  }
}
