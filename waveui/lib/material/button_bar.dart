...
class ButtonBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget child = ButtonTheme.fromButtonThemeData(
      ...
      child: _ButtonBarRow(
        ...
        children:
            children
                .map<Widget>((child) => Padding(padding: EdgeInsets.symmetric(horizontal: paddingUnit), child: child))
                .toList(),
      ),
    );
    switch (buttonTheme.layoutBehavior) {
      ...
      case ButtonBarLayoutBehavior.constrained:
        return ConstrainedBox(
          ...
          child: Padding(padding: EdgeInsets.symmetric(horizontal: paddingUnit), child: Center(child: child)),
        );
    }
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(EnumProperty<ButtonTextTheme?>('buttonTextTheme', buttonTextTheme));
    properties.add(DoubleProperty('buttonMinWidth', buttonMinWidth));
    ...
    properties.add(DiagnosticsProperty<bool?>('buttonAlignedDropdown', buttonAlignedDropdown));
    properties.add(EnumProperty<ButtonBarLayoutBehavior?>('layoutBehavior', layoutBehavior));
    properties.add(EnumProperty<VerticalDirection?>('overflowDirection', overflowDirection));
    properties.add(DoubleProperty('overflowButtonSpacing', overflowButtonSpacing));
  }
}
...
class _ButtonBarRow extends Flex {
  ...
  @override
  _RenderButtonBarRow createRenderObject(BuildContext context) => _RenderButtonBarRow(
    direction: direction,
