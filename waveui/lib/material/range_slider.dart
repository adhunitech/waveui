...
class RangeSlider extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<WidgetStateProperty<ui.Color?>?>('overlayColor', overlayColor));
...
class _RangeSliderState extends State<RangeSlider> with TickerProviderStateMixin {
  ...
  RangeValues _lerpRangeValues(RangeValues values) => RangeValues(_lerp(values.start), _lerp(values.end));
  ...
  RangeValues _unlerpRangeValues(RangeValues values) => RangeValues(_unlerp(values.start), _unlerp(values.end));
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<AnimationController>('startPositionController', startPositionController));
    properties.add(DiagnosticsProperty<AnimationController>('endPositionController', endPositionController));
    properties.add(DiagnosticsProperty<Timer?>('interactionTimer', interactionTimer));
    properties.add(ObjectFlagProperty<PaintRangeValueIndicator?>.has('paintTopValueIndicator', paintTopValueIndicator));
    properties.add(
      ObjectFlagProperty<PaintRangeValueIndicator?>.has('paintBottomValueIndicator', paintBottomValueIndicator),
    );
...
class _RangeSliderRenderObjectWidget extends LeafRenderObjectWidget {
  ...
  @override
  _RenderRangeSlider createRenderObject(BuildContext context) => _RenderRangeSlider(
    values: values,
    divisions: divisions,
    labels: labels,
    sliderTheme: sliderTheme,
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<RangeValues>('values', values));
    properties.add(IntProperty('divisions', divisions));
    properties.add(DiagnosticsProperty<RangeLabels?>('labels', labels));
    properties.add(DiagnosticsProperty<SliderThemeData>('sliderTheme', sliderTheme));
    properties.add(DoubleProperty('textScaleFactor', textScaleFactor));
    properties.add(DiagnosticsProperty<ui.Size>('screenSize', screenSize));
    properties.add(ObjectFlagProperty<ValueChanged<RangeValues>?>.has('onChanged', onChanged));
    properties.add(ObjectFlagProperty<ValueChanged<RangeValues>?>.has('onChangeStart', onChangeStart));
    properties.add(ObjectFlagProperty<ValueChanged<RangeValues>?>.has('onChangeEnd', onChangeEnd));
    properties.add(
      ObjectFlagProperty<SemanticFormatterCallback?>.has('semanticFormatterCallback', semanticFormatterCallback),
    );
    properties.add(DiagnosticsProperty<_RangeSliderState>('state', state));
...
class _RenderRangeSlider extends RenderBox with RelayoutWhenSystemFontsChangeMixin {
  ...
  // (0,0).
  Rect get _trackRect =>
      _sliderTheme.rangeTrackShape!.getPreferredRect(parentBox: this, sliderTheme: _sliderTheme, isDiscrete: false);
  ...
  RangeValues _discretizeRangeValues(RangeValues values) =>
      RangeValues(_discretize(values.start), _discretize(values.end));
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    _startThumbCenter = Offset(
      clampDouble(startThumbPosition, trackRect.left + thumbPadding, trackRect.right - thumbPadding),
      thumbYOffset,
    );
    ...
    if (shouldPaintValueIndicators) {
      ...
      final double endHalfWidth =
          sliderTheme.rangeValueIndicatorShape!
              .getPreferredSize(isEnabled, isDiscrete, labelPainter: _endLabelPainter, textScaleFactor: textScaleFactor)
              .width /
          2;
  ...
  double get _decreasedStartValue => clampDouble(values.start - _semanticActionUnit, 0.0, 1.0);

  double get _increasedEndValue => clampDouble(values.end + _semanticActionUnit, 0.0, 1.0);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<ui.Rect?>('overlayStartRect', overlayStartRect));
    properties.add(DiagnosticsProperty<ui.Rect?>('overlayEndRect', overlayEndRect));
    ...
    properties.add(ObjectFlagProperty<ValueChanged<RangeValues>?>.has('onChangeStart', onChangeStart));
    properties.add(ObjectFlagProperty<ValueChanged<RangeValues>?>.has('onChangeEnd', onChangeEnd));
    properties.add(EnumProperty<ui.TextDirection>('textDirection', textDirection));
    properties.add(DiagnosticsProperty<bool>('hovering', hovering));
    properties.add(DiagnosticsProperty<bool>('hoveringStartThumb', hoveringStartThumb));
    properties.add(DiagnosticsProperty<bool>('hoveringEndThumb', hoveringEndThumb));
