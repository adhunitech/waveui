...
class ChipTheme extends InheritedTheme {
  const ChipTheme({required this.data, required super.child, super.key});
  ...
  @override
  Widget wrap(BuildContext context, Widget child) => ChipTheme(data: data, child: child);
...
class ChipThemeData with Diagnosticable {
  ...
  static ChipThemeData? lerp(ChipThemeData? a, ChipThemeData? b, double t) {
    ...
    return ChipThemeData(
      ...
      iconTheme:
          a?.iconTheme != null || b?.iconTheme != null ? IconThemeData.lerp(a?.iconTheme, b?.iconTheme, t) : null,
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<WidgetStateProperty<Color?>>('color', color, defaultValue: null));
    ...
    properties.add(
      DiagnosticsProperty<BoxConstraints>('avatarBoxConstraints', avatarBoxConstraints, defaultValue: null),
    );
    properties.add(
      DiagnosticsProperty<BoxConstraints>('deleteIconBoxConstraints', deleteIconBoxConstraints, defaultValue: null),
    );
  }
}
