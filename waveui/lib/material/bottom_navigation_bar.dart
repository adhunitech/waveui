...
class BottomNavigationBar extends StatefulWidget {
  BottomNavigationBar({
    ...
    this.useLegacyColorScheme = true,
       ...
       assert(items.every((item) => item.label != null), 'Every item must have a non-null label'),
...
class _BottomNavigationBarState extends State<BottomNavigationBar> with TickerProviderStateMixin {
  ...
  List<Widget> _createTiles(BottomNavigationBarLandscapeLayout layout) {
    ...
    for (int i = 0; i < widget.items.length; i++) {
      final Set<WidgetState> states = <WidgetState>{if (i == widget.currentIndex) WidgetState.selected};
      ...
      tiles.add(
        _BottomNavigationTile(
          ...
          showUnselectedLabels:
              widget.showUnselectedLabels ?? bottomTheme.showUnselectedLabels ?? _defaultShowUnselected,
