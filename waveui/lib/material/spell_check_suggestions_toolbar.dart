...
import 'package:waveui/material/spell_check_suggestions_toolbar_layout_delegate.dart';
...
class SpellCheckSuggestionsToolbar extends StatelessWidget {
  const SpellCheckSuggestionsToolbar({required this.anchor, required this.buttonItems, super.key})
    : assert(buttonItems.length <= _kMaxSuggestions + 1);

  SpellCheckSuggestionsToolbar.editableText({required EditableTextState editableTextState, super.key})
